...
void levelThree::Init()
{
	...
	std::unique_ptr<box> bomb_uptr = factory_box_uptr->create(Vector2(300, 300));
	...
	bomb_uptr = factory_box_uptr->create(Vector2(100, 450));
	bomb_uptr = std::make_unique<decoratorBoxLarge>(std::move(bomb_uptr));
	bomb_uptr = std::make_unique<decoratorBombBox>(std::move(bomb_uptr));
	boxs.push_back(std::move(bomb_uptr));

	bomb_uptr = factory_box_uptr->create(Vector2(200, 150));
	bomb_uptr = std::make_unique<decoratorBoxMedium>(std::move(bomb_uptr));
	bomb_uptr = std::make_unique<decoratorBombBox>(std::move(bomb_uptr));
	boxs.push_back(std::move(bomb_uptr));

	bomb_uptr = factory_box_uptr->create(Vector2(400, 350));
	bomb_uptr = std::make_unique<decoratorBoxSmall>(std::move(bomb_uptr));
	bomb_uptr = std::make_unique<decoratorBombBox>(std::move(bomb_uptr));
	boxs.push_back(std::move(bomb_uptr));

	std::unique_ptr<box> safe_uptr = factory_box_uptr->create(Vector2(200, 200));
